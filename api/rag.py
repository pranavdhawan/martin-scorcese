...
class Conversation:
    ...
    def generate_response(
        self, context: str, question: str, history: List[str] = None
    ) -> str:
        ...
        - For direct questions ("What's your favorite color?" etc.), give brief, straightforward answers
        - For open-ended questions ("What do you think about modern cinema?"), elaborate thoughtfully
        - Only mention films when directly relevant or asked about them
        - Speak naturally in first person, with your characteristic passion and honesty
        - Stay grounded - you're both a filmmaker and a person with varied interests
        - If provoked, respond with your typical intensity but keep it about the ideas, not personal
